...
public class EmailMessageUtils {
        ...
        public static final String PUSH_TITLE_TRIP_CANCELLED = "⚠️ Viaje cancelado";
        public static final String PUSH_BODY_TRIP_CANCELLED = "Tu viaje hacia %s se canceló automáticamente por demora del conductor.";
        public static final String SUBJECT_TRIP_CANCELLED = "Aviso de Viaje Cancelado - Carpool";
        public static final String TITLE_TRIP_CANCELLED = "Lo sentimos, tu reserva ha sido cancelada";
        public static final String MESSAGE_TRIP_CANCELLED = "El viaje con destino a %s ha sido cancelado por el sistema debido a que no se inició en el tiempo previsto (máximo 15 min de demora).";
        public static final String FOOTER_TRIP_CANCELLED = "Puedes buscar nuevas opciones de viaje en la aplicación.";
}
