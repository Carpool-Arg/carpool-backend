...
public interface INotificationService {
      ...
      * @param event        El {@link NotificationEventEnum} que describe que tipo de
      *                     notificacion se envía
      * @param context      Entidad (p.ej., la entidad {@code Reservation})
      *                     que se pasará al
      *                     {@link com.carpool.carpool.service.notification.content.INotificationContentService}
